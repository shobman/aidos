...
| C11 | Unit coherence | The artifact is internally consistent. Terminology is used the same way throughout, sections don't contradict each other, and the document reads as one coherent unit rather than fragments assembled from different sessions. |
